  ...
  <div>
    <TsContain border="border">
      <template slot="top">
        ...
        &nbsp;
        <Button type="primary" @click="toggleStatus()">改变节点状态</Button>
         &nbsp;
        <Button type="primary" @click="updateLineText()">改变线名称</Button>
        &nbsp;
        <Button type="primary" @click="addNode()">增加节点</Button>
      </template>
