            ...
            <template v-slot:action="{row}">
              <div class="tstable-action">
                <ul class="tstable-action-ul">
                  ...
                  <li :class="{'text-grey disable': row.processCount > 0}" @click="remove(row)"><span>{{ $t('button.delete') }}</span></li>
...
export default {
  ...
  data() {
    return {
      ...
      theadList: [
        {title: this.$t('page.templatename'), key: 'name', type: 'linktext', textValue: 'view'},
