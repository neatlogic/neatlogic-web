<template>
  <div id="slamanage">
    <div style="height: 48px; padding: 0 24px; background: white;">
      <TsFormInput search placeholder="所有服务类型" style="width: calc(25% - 12px); margin-top: 9px; float: right;"></TsFormInput>
    </div>
      ...
      <div class="numberBlock clearfix">
        ...
        <div style="background: #009487;">
          ...
          <div class="content updown">
            <div class="label">最大服务时效top3（h)</div>
            <div class="num">
              <div>42</div>
              <div>42</div>
              <div>42</div>
        ...
        <div style="background: #4253AF;">
          ...
          />
          <div class="content updown">
            <div class="label">最小服务时效top3（h)</div>
            <div class="num">
              <div>42</div>
              <div>42</div>
              <div>42</div>
