            ...
            <template v-slot:content>
              ...
              >
                <CenterDetail
                  ...
                  :defaultTabValue="isShowJob? 'createjob' : ''"
                  @update="update"
                  @changeDisableCommet="(val)=>{
                    isDisableCommet = val
                  }"
                >
                  <template v-if="isShowJob" v-slot:createjob>
                    <!-- 自动化作业 -->
...
export default {
  ...
  components: {
    ...
    JobDetail: () => import('@/views/pages/process/task/processdetail/workorder/createjob/job-detail.vue'),
