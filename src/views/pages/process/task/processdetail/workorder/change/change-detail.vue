                    ...
                    <div class="comment-detail">
                      <div>
                        ...
                        <div v-if="!comment.editContent&&(comment.isDeletable == 1 || comment.isEditable == 1)" class="comment-btn">
                          <Button v-if="comment.isEditable == 1" size="small" @click="editStepComment(comment)">{{ $t('button.add') }}</Button>
                          <Button v-if="comment.isDeletable == 1" size="small" @click="delStepComment(comment, cd)">{{ $t('button.delete') }}</Button>
                        </div>
                      </div>
