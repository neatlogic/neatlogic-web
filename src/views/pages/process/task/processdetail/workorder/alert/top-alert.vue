 ...
 */
<template>
  <div v-if="list.length > 0 || processTaskVo" class="task-alert bg-op radius-sm" :class="(list && list.length > 1) || (list && list.length > 0 && processTaskVo)?'align-start':'align-center'">
