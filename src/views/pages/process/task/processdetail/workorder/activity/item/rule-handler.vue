          ...
          <TsRow className="flew-box">
                  ...
                  <div v-if="item.conditionGroupList">
                    <Tooltip max-width="800" transfer theme="light">
                      <span v-for="(groupitem, groupindex) in item.conditionGroupList" :key="groupindex">
                        ...
                        <span v-if="item.conditionGroupRelList && item.conditionGroupRelList[groupindex]" class="text-primary" style="margin:0 6px;">{{ item.conditionGroupRelList[groupindex].joinType === 'or' ? '或' : '且' }}</span>
                      </span>
                      <div slot="content">
                        <span v-for="(groupitem, groupindex) in item.conditionGroupList" :key="groupindex">
                          <span>(</span>
            ...
            <Col span="4">
              <div class="status dividing-color">
                <span v-if="item.result==true" class="text-success">已匹配</span>
                <span v-else class="text-title">未匹配</span>
              </div>
            </Col>
          </TsRow>
        </div>
