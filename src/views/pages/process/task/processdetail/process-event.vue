          ...
          <div class="toolbar-right">
            <div class="action-group">
              <!-- <span class="action-item">
                  <Checkbox v-model="showActive">隐藏活动步骤</Checkbox>
              </span>-->
              <!-- 开始_start -->
              <span
...
export default {
  ...
  components: {
    ...
    EventEdit: resolve => require(['./workorder/event/event-edit.vue'], resolve),
  ...
  methods: {
    ...
    async completeTask() {
      //流转
      let content = this.$refs.eventConfig ? this.$refs.eventConfig.getEventData().content : null;
