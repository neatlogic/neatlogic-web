      ...
      <Card style="width:100%;" :padding="0">
        ...
        <CellGroup style="max-height: 340px; overflow: auto;">
          <Cell
            ...
            :key="index"
            :title="item.msg"
            @click.native="validItemClick(item.focus, item.tabValue)"
          >
            <Icon
              slot="icon"
              :custom="item.icon"
...
import itemDialog from './workorder/actiondialog/index.js'; //弹框集合
...
export default {
  ...
  components: {
    ...
    ...itemDialog,
    FooterOperationBtn,
    EoaDetail: resolve => require(['@/views/pages/process/task/processdetail/workorder/eoa/eoa-detail.vue'], resolve)
  },
  provide() {
    return {
      $taskBox: this
