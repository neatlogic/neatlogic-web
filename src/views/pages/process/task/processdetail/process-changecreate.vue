            ...
            <template v-slot:content>
              ...
              >
                <CenterDetail
                  ...
                  :slotList="[{ name: 'changecreate', label: $t('term.process.changedetail') }]"
                  @update="update"
                  ...
                  <template v-slot:changecreate>
                    <div v-if="startProcessTaskStep.handler != 'changecreate'" id="changeInfo">
                      <ChangecreateDispatch
                        v-if="startProcessTaskStep.handler != 'changecreate'"
      ...
      <Card style="width:100%;" :padding="0">
        ...
        <CellGroup style="max-height: 340px; overflow: auto;">
          <Cell
            ...
            :key="index"
            :title="item.msg"
            @click.native="validItemClick(item.focus, 'changeDetails')"
          >
            <Icon
              slot="icon"
              :custom="item.icon"
...
export default {
  ...
  components: {
    ...
    ChangecreateDispatch: () => import('@/views/pages/process/task/processdetail/workorder/change/changecreate-dispatch.vue'),
    ChangecreateStep: () => import('@/views/pages/process/task/processdetail/workorder/change/changecreate-detail'),
  ...
  methods: {
    ...
    changeValid() {
      //变更校验
      let validList = [];
      validList = this.$refs.changecreateData ? this.$refs.changecreateData.changeValid() : [];
