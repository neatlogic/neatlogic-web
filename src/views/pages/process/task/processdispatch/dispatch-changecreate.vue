    ...
    valid() {
      ...
      if (this.$refs.planStartEndTime && !this.$refs.planStartEndTime.valid()) {
        validList.push({
          ...
          icon: 'tsfont-close-o',
          msg: this.$t('message.content.process.required', {target: this.$t('term.process.planStartEndTime')}),
          type: 'error',
      ...
      if (this.$refs.changeStepList && this.$refs.changeStepList.validParam().length > 0) {
        validList.push({
          ...
          icon: 'tsfont-close-o',
          msg: this.$t('message.content.process.required', {target: this.$t('term.process.changeparams')}),
          type: 'error',
          showDetail: 'handlerStepInfo'
        });
      }
      if (this.$refs.TsCkeditor && !this.$refs.TsCkeditor.valid()) {
        validList.push({
          ...
          icon: 'tsfont-close-o',
          msg: this.$t('message.content.process.required', {target: this.$t('term.process.changecontent')}),
          type: 'error',
          showDetail: 'centent'
        });
      }
