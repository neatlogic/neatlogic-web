<template>
  <div ref="changeBox" class="change-detail" @click.stop>
    <div class="from-list">
                ...
                <div class="tooltip-box">
                  <div class="tooltip tipbottom">
                    <div class="tooltip-content input-border">
                      ...
                      <div class="btn-user">
                        <Button type="text" size="small" @click="cancelAllUser">{{ $t('button.cancel') }}</Button>
                        <Button
                          type="primary"
                          size="small"
                          style="margin:0;"
      ...
      <div v-if="newChangeStepList && newChangeStepList.length>0" class="change-main card-wrapper pt-nm">
        ...
        >
          ...
          <div v-if="cd.isShow" class="content-box radius-sm bg-tip-grey">
    ...
    <div v-if="newChangeStepList.length>0 && changeParamList.length>0" id="changeParam">
      <div class="text-grey pb-sm require-label">模板变量替换</div>
      <div class="param-box">
        <TsRow>
          <Col
