    ...
    >
      <div class="submitModelBox">
        ...
        <div class="submit-btn-list pb-sm">
          <Button size="large" style="width:190px;" @click="viewWork(), saveProfile('viewprocesstaskdetail')">查看工单</Button>
        </div>
        <div class="submit-btn-list pb-sm">
          <Button size="large" style="width:190px;" @click="continueSubmit(), saveProfile('keeponcreatetask')">继续上报</Button>
        </div>
        <div class="submit-btn-list pb-sm">
          <Button
            to="catalog-overview"
        ...
        <div class="submit-btn-list pb-sm">
          <Checkbox v-model="submitMessage">
            不再提示
            <i class="ts-m-problem" title="可在个人设置中修改"></i>
          </Checkbox>
        </div>
      </div>
    </TsDialog>
