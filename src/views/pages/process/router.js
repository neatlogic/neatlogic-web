...
let routerArr = [
  ...
  },
  {
    ...
    meta: {
      title: 'router.process.workordercenter',
      ismenu: true,
      icon: 'tsfont-task',
  ...
  },
  {
    ...
    meta: {
      title: 'router.process.servicecatalogmanage',
      ismenu: true,
      icon: 'tsfont-list',
  ...
  },
  {
    ...
    meta: {
      title: 'router.process.taskdispatch',
      ismenu: false,
      icon: 'ts-m-signature',
      authority: '',
      type: 'task'
  ...
  },
  {
    ...
    meta: {
      title: 'router.process.taskdetail',
      ismenu: false,
      icon: 'ts-m-signature',
      authority: '',
      type: 'task'
  ...
  },
  {
    ...
    meta: {
      title: 'router.process.flowmanage',
      ismenu: true,
      icon: 'tsfont-flow',
  ...
  },
  {
    ...
    meta: {
      title: 'router.process.nodemanage',
      ismenu: true,
      icon: 'tsfont-node',
  ...
  },
  {
    ...
    component: slaManage,
    meta: {
      title: 'router.process.slamanage',
      ismenu: false,
      icon: 'tsfont-sla',
...

  {
    ...
    meta: {
      title: 'router.process.eventtypemanage',
      ismenu: true,
      icon: 'tsfont-module',
  ...
  },
  {
    ...
    meta: {
      title: 'router.process.eventsolutionmanage',
      ismenu: true,
  ...
  },
  {
    ...
    meta: {
      title: 'router.process.eventsolutionedit',
      ismenu: false,
      authority: 'EVENT_SOLUTION_MODIFY'
    }
  },
  {
    ...
    meta: {
      title: 'router.process.subtasktypemanage',
      ismenu: true,
  ...
  },
  {
    ...
    meta: {
      title: 'router.process.prioritymanage',
      ismenu: true,
      icon: 'tsfont-history',
  ...
  },
  {
    ...
    meta: {
      title: 'router.process.scoretemplatemanage',
      ismenu: true,
      icon: 'tsfont-stars',
  ...
  },
  {
    ...
    meta: {
      title: 'router.process.channeltypemanage',
      ismenu: true,
      icon: 'ts-m-urgency',
  ...
  },
  {
    ...
    meta: {
      title: 'router.process.taskbatchdispatch',
      ismenu: true,
      icon: 'ts-m-signature',
      authority: 'PROCESS_MODIFY',
      type: 'catalog'
  ...
  },
  {
    ...
    meta: {
      title: 'router.process.changemanage',
      ismenu: true,
      icon: 'tsfont-change',
  ...
  },
  {
    ...
    meta: {
      title: 'router.process.changeedit',
      ismenu: false,
      icon: 'tsfont-change',
      authority: 'CHANGE_MODIFY',
      type: 'flow'
  ...
  },
  {
    ...
    meta: {
      title: 'router.process.reltypemanage',
      ismenu: true,
  ...
  },
  {
    ...
    meta: {
      title: 'router.process.replymanage',
      ismenu: true,
      icon: 'tsfont-modules',
      authority: 'PROCESS_COMMENT_TEMPLATE_MODIFY',
      type: 'others'
    }
  }
];
