                ...
                <Col span="6">
                  <div class="list pl-lg pr-lg radius-md mb-nm overflow bg-op">
                    ...
                    <div class="overflow">
                      ...
                      >
                        <div slot="content" class="overflow text-grey" v-html="seritem.desc ? removeHTMLTag(escape2Html(seritem.desc)) : ''"></div>
                        <div class="overflow text-grey" v-html="seritem.desc ? removeHTMLTag(escape2Html(seritem.desc)) : '-'"></div>
                      </Tooltip>
                    </div>
                  </div>
                </Col>
