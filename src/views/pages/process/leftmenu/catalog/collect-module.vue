    ...
    <div class="services-catalog-box">
      <div class="path-box pb-sm pt-sm">
        ...
        <div class="text-action" @click="lookMore(collectData)">
          <span v-show="collectData.pageCount > 1">查看更多</span>
        </div>
      </div>
                  ...
                  >
                    ...
                    <div class="overflow">
                      ...
                      <Tooltip
                        ...
                        :disabled="!item.desc"
                      >
                        <div slot="content" class="overflow text-grey" v-html="item.desc ? removeHTMLTag(escape2Html(item.desc)) : ''"></div>
                        <div class="overflow text-grey" v-html="item.desc ? removeHTMLTag(escape2Html(item.desc)) : '-'"></div>
                      </Tooltip>
                    </div>
                  </div>
                </Col>
