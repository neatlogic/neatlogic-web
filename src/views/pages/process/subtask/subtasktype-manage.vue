            ...
            <template v-slot:action="{row}">
              <div class="tstable-action">
                <ul class="tstable-action-ul">
                  ...
                  <li :class="{'text-grey disable': row.referenceCount > 0}" @click="remove(row)"><span>{{ $t('button.delete') }}</span></li>
                </ul>
              </div>
            </template>
          </TsTable>
    ...
    return {
      ...
      btnFormConfig: [
        ...
        },
        {
          type: 'text',
          name: 'defaultContent',
          label: this.$t('form.label.defaultcontent')
        },
        {
          type: 'switch',
          name: 'isRequired',
          label: this.$t('form.label.desrequired'),
          trueValue: 1,
          falseValue: 0
        }
      ],
