  ...
  <TsContain border="border">
    ...
    <template v-slot:topRight>
      <div class="action-group">
        ...
        <div class="action-item"><Button type="primary" :disabled="saving" @click="saveSolution">{{ $t('button.save') }}</Button></div>
      </div>
    </template>
        ...
        <div class="editor-container">
          <TsForm :itemList="formItemList">
            <template v-slot:type>
              <div class="action-group">
                <span class="action-item tsfont-edit" @click="toEventTypeManage">{{ $t('page.classifytarget', {target:$t('button.edit')}) }}</span>
  ...
  data() {
    ...
    return {
      ...
      formItemList: {
        ...
        content: {
          type: 'ckeditor',
          label: this.$t('form.label.content'),
  ...
  methods: {
    ...
    async saveSolution() {
      ...
      if (this.solutionConfig.content === '') {
        this.$Notice.error({ title: this.$t('message.title.error'), desc: this.$t('message.content.required', {target: this.$t('term.process.solutioncontent')})});
        return false;
      }
      if (!this.saving) {
        this.saving = true;
