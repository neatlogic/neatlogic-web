          ...
          <template v-slot:file>
            <div>
              ...
              <div class="text-tip tips desc-text-mt">
                {{ $t('message.content.cmdb.xmlconfig') }}
                <Poptip
                  trigger="hover"
                  placement="right"
                  width="450"
...
&lt;/ci&gt;
      ...
      <template v-slot:footer>
        ...
        <Button type="primary" @click="saveCi()">{{ $t('button.confirm') }}</Button>
      </template>
    </TsDialog>
    <IconDialog
    ...
    return {
      ...
      ciFormConfig: [
        ...
        },
        {
          ...
          desc: this.$t('message.content.cmdb.abstractmodelextend'),
          value: 0,
          onChange: function(name) {
        ...
        },
        {
          ...
          desc: this.$t('message.content.cmdb.keymodel'),
          value: 0,
          onChange: function(name) {
        ...
        },
        {
          ...
          min: 0,
          desc: this.$t('message.content.cmdb.activedate'),
          onChange: function(name) {
