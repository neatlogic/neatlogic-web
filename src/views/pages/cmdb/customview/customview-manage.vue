      ...
      <template slot="topLeft">
        <Dropdown placement="bottom-start">
          ...
          <DropdownMenu slot="list">
            <DropdownItem @click.native="addCustomView">数据视图</DropdownItem>
            <DropdownItem @click.native="addGraph">拓扑视图</DropdownItem>
          </DropdownMenu>
        </Dropdown>
      </template>
              ...
              <template slot="action" slot-scope="{ row }">
                <div class="tstable-action">
                  <ul class="tstable-action-ul">
                    <li class="icon tsfont-edit" @click.stop="editCustomView(row)">编辑</li>
                  </ul>
                </div>
              </template>
            </TsTable>
          </TabPane>
          <TabPane label="拓扑视图" name="topo">
            <TsTable
              v-if="graphData"
              :theadList="theadList"
              v-bind="graphData"
            ...
            >
              ...
              <template slot="action" slot-scope="{ row }">
                <div class="tstable-action">
                  <ul class="tstable-action-ul">
                    <li class="icon tsfont-edit" @click.stop="editGraph(row)">编辑</li>
                  </ul>
                </div>
              </template>
            </TsTable>
