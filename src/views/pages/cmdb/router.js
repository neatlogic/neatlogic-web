...
let routerArr = [
...

  {
    ...
    meta: {
      title: 'router.cmdb.globalsearch',
      ismenu: true,
      type: 'cientitymanage',
      authority: 'CMDB_BASE',
      icon: 'tsfont-search'
  ...
  },
  {
    ...
    meta: {
      title: 'router.cmdb.searchcientity',
      ismenu: true,
      type: 'cientitymanage',
      authority: 'CMDB_BASE',
      icon: 'ts-listsetting'
  ...
  },
  {
    ...
    meta: {
      title: 'router.cmdb.transactionaudit',
      ismenu: true,
      type: 'cientitymanage',
      icon: 'tsfont-eoa',
  ...
  },
  {
    ...
    meta: {
      type: 'resourceCenter',
      title: 'router.cmdb.applicationlist',
      ismenu: true,
      icon: 'tsfont-app',
  ...
  },
  {
    ...
    meta: {
      type: 'resourceCenter',
      title: 'router.cmdb.accountmanage',
      ismenu: true,
  ...
  },
  {
    ...
    meta: {
      title: 'router.cmdb.discoverymanage',
      ismenu: true,
      type: 'discovery',
  ...
  },
  {
    ...
    meta: {
      title: 'router.cmdb.discoveryconfig',
      ismenu: true,
      type: 'discovery',
      icon: 'tsfont-cluster',
      authority: 'SYNC_MODIFY'
  ...
  },
  {
    ...
    meta: {
      title: 'router.cmdb.discoveryjobmanage',
      ismenu: false,
      type: 'discovery'
    }
  },
  {
    ...
    meta: {
      title: 'router.cmdb.discoveryjobdetail',
      ismenu: false,
      type: 'discovery'
    }
  },
  {
    ...
    meta: {
      title: 'router.cmdb.discoverydata',
      ismenu: false,
      type: 'discovery',
      authority: 'SYNC_MODIFY'
    }
  },
  {
    ...
    meta: {
      title: 'router.cmdb.unknownmanage',
      ismenu: false,
      type: 'discovery',
      authority: 'SYNC_MODIFY'
    }
  },
  {
    ...
    meta: {
      title: 'router.cmdb.discoveryrulemanage',
      ismenu: false,
      type: 'discovery',
      authority: 'SYNC_MODIFY'
    }
  ...
  },
  {
    ...
    meta: {
      title: 'router.cmdb.validatormanage',
      ismenu: true,
      type: 'cmdbmanage',
      icon: 'tsfont-check-o',
      authority: 'CI_MODIFY'
  ...
  },
  {
    ...
    meta: {
      title: 'router.cmdb.customviewmanage',
      ismenu: true,
      type: 'cmdbmanage',
  ...
  },*/
  {
    ...
    meta: {
      title: 'router.cmdb.reltypemanage',
      ismenu: true,
      type: 'cmdbmanage',
      icon: 'tsfont-node',
  ...
  },
  {
    ...
    meta: {
      title: 'router.cmdb.alertlevelmanage',
      ismenu: true,
      type: 'cmdbmanage',
  ...
  },
  {
    ...
    meta: {
      title: 'router.cmdb.cientityedit',
      ismenu: false,
      authority: 'CMDB_BASE'
    }
  },
  {
    ...
    meta: {
      title: 'router.cmdb.cientitybatchedit',
      ismenu: false,
      authority: 'CMDB_BASE'
    }
  },
  {
    ...
    meta: {
      title: 'router.cmdb.cientityview',
      ismenu: false,
      authority: 'CMDB_BASE'
    }
  },
  {
    ...
    meta: {
      title: 'router.cmdb.cientitylist',
      ismenu: false,
      authority: 'CMDB_BASE'
    }
  },
  ...
  },
  {
    ...
    meta: {
      title: 'router.cmdb.applicationdetail',
      ismenu: false,
      authority: 'CMDB_BASE'
    }
  },
  {
    ...
    meta: {
      title: 'router.cmdb.syncauditmanage',
      ismenu: false,
      authority: 'CMDB_BASE'
    }
  },
  ...
  },
  {
    ...
    meta: {
      title: 'router.cmdb.inspectstatus',
      ismenu: false,
