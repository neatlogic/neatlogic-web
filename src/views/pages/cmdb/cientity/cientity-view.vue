    ...
    <TsContain :hideHeader="hideHeader" :enableCollapse="!ciEntityData.isVirtual" border="border">
      ...
      <template v-slot:topRight>
        <div class="action-group" style="text-align:right">
          <span v-if="ciEntityData && ciEntityData.authData && ciEntityData.authData.cientityupdate" class="action-item tsfont-edit" @click="toEditCiEntity">{{ $t('button.edit') }}</span>
      ...
      <template v-slot:sider>
        <div>
          ...
          <Divider v-if="relGroupList" orientation="center" style="margin:3px 0px;font-size:13px">{{ $t('term.cmdb.relation') }}</Divider>
                  ...
                  <Card :bordered="false" dis-hover>
                    ...
                    <div>
                      <div v-if="activedPanel == 'attr' || activedPanel == ''">
                        ...
                        <div v-if="(attrList && attrList.length > 0) || (constList && constList.length > 0)" class="attr-main">
                          <div
