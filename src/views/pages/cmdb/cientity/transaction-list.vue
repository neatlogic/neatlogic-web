        ...
        <template slot="action" slot-scope="{ row }">
          <div class="tstable-action">
            <ul class="tstable-action-ul">
              <li class="tsfont-check-o" :class="row.authData && row.authData.transactionmanage ? '' : 'disable'" @click="commitTransation(row)">{{ $t('button.submit') }}</li>
              <li class="tsfont-trash-o" :class="row.authData && row.authData.transactionmanage ? '' : 'disable'" @click="deleteTransaction(row)">{{ $t('button.delete') }}</li>
            </ul>
          </div>
        </template>
      </TsTable>
