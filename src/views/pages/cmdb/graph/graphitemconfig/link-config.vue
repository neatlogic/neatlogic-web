<template>
  <div>
    ...
    <TsFormItem :label="$t('form.label.style')" labelPosition="top">
      <div class="padding-sm radius-sm">
        <TsFormRadio v-model="config.style" :dataList="typeList"></TsFormRadio>
      </div>
    </TsFormItem>
    <TsFormItem :label="$t('form.label.animation')" labelPosition="top">
      <div class="padding-sm radius-sm">
        <TsFormSwitch
          :value="config.animationTimes === -1"
          :trueValue="true"
          :falseValue="false"
          @on-change="
            val => {
              if (val) {
                setConfig('animationTimes', -1);
              } else {
                setConfig('animationTimes', 0);
              }
            }
          "
        ></TsFormSwitch>
    ...
    <TsFormItem :label="$t('form.label.color')" labelPosition="top">
      <div class="padding-sm radius-sm">
        <ColorPicker
