<template>
  <div>
    ...
    <TsFormItem :label="$t('form.label.bordercolor')" labelPosition="top">
      <div class="padding-sm radius-sm">
        <ColorPicker
    ...
    <TsFormItem :label="$t('term.cmdb.strokewidth')" labelPosition="top">
      <div class="padding-sm radius-sm">
        <Slider v-model="config.strokewidth" :min="0" :max="10"></Slider>
      </div>
    </TsFormItem>
