        ...
        <div>
          ...
          <div class="common-auth">
            <div v-if="relateConfig && relateConfig?.typeList?.length > 0" class="wrapper">
              <span class="text check-all-text-pr mb-nm" :class="[ selectedAll ? 'ts-check-square-o':'tsfont-minus-square']" @click.stop="handleCheckedAll()">
              ...
              <div v-for="(item, index) in relateConfig.typeList" :key="index" class="item mb-md">
                ...
                <div class="radius-lg bg-op">
                  <div class="pl-nm pt-nm h2 flex-start" :class="secondSelectedAll(item) ? 'ts-check-square-o':'tsfont-minus-square'" @click.stop="handleSecondCheckedAll(item)">
