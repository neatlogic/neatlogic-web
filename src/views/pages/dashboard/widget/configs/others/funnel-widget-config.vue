<template>
  <div>
    ...
    <div class="ivu-form-item tsform-item ivu-form-label-top">
      <label class="ivu-form-item-label overflow">{{ $t('term.report.chartsetting.dynamicheight') }}</label>
      <div class="ivu-form-item-content">
        <TsFormSwitch
          :value="config.dynamicHeight"
          :true-value="true"
          :false-value="false"
          @change="
            val => {
              setConfigValue('dynamicHeight', val);
            }
          "
        ></TsFormSwitch>
      </div>
    ...
    <div class="ivu-form-item tsform-item ivu-form-label-top">
      <label class="ivu-form-item-label overflow">{{ $t('term.report.chartsetting.transpose') }}</label>
      <div class="ivu-form-item-content">
        <TsFormSwitch
          :value="config.isTransposed"
          :true-value="true"
          :false-value="false"
          @change="
            val => {
              setConfigValue('isTransposed', val);
            }
          "
        ></TsFormSwitch>
      </div>
