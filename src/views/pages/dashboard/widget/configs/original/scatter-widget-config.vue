<template>
  <div>
    ...
    <div class="ivu-form-item tsform-item ivu-form-label-top">
      <label class="ivu-form-item-label overflow">{{ $t('term.report.bubbleshape') }}</label>
      <div class="ivu-form-item-content">
        <TsFormRadio
          :dataList="[{value:'circle',text:$t('term.report.circle')},{value:'square',text:$t('term.report.square')}]"
          :value="config.shape"
          @change="
            val => {
    ...
    <div class="ivu-form-item tsform-item ivu-form-label-top">
      <label class="ivu-form-item-label overflow">{{ $t('term.report.bubblesize') }}</label>
      <div class="ivu-form-item-content">
    ...
    <div class="ivu-form-item tsform-item ivu-form-label-top">
      <label class="ivu-form-item-label overflow">{{ $t('term.report.axis.colorfieldalias') }}</label>
      <div class="ivu-form-item-content">
        <TsFormInput
    ...
    <div class="ivu-form-item tsform-item ivu-form-label-top">
      <label class="ivu-form-item-label overflow">{{ $t('term.report.axis.sizefieldalias') }}</label>
      <div class="ivu-form-item-content">
        <TsFormInput
