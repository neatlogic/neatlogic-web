      ...
      <div v-if="mode == 'edit' && widget._selected" class="config-btn">
        <Dropdown>
          ...
          <DropdownMenu slot="list">
            <DropdownItem @click.native="moveTop">移到顶端</DropdownItem>
            <DropdownItem @click.native="moveUp">上移一层</DropdownItem>
            <DropdownItem @click.native="moveDown">下移一层</DropdownItem>
            <DropdownItem @click.native="moveFloor">移到底端</DropdownItem>
          </DropdownMenu>
        </Dropdown>
      </div>
