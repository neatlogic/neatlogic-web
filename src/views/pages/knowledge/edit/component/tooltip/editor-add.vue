<template>
  <div
    ...
    :style="getStyle"
  >
    <span class="span-add" title="添加组件" @mousedown.prevent="isShow=!isShow"></span>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      dataList: [{
        type: 'ul',
        title: this.$t('page.addtarget', { target: this.$t('page.unorderedlist') }),
        icon: 'tsfont-list'
      }, {
        type: 'ol',
        title: this.$t('page.addtarget', { target: this.$t('page.orderedlist') }),
        icon: 'tsfont-orderlist'
      }, {
        type: 'img',
        title: this.$t('page.addtarget', { target: this.$t('page.image') }),
        icon: 'tsfont-addimg'
      }, {
        type: 'table',
        title: this.$t('page.addtarget', { target: this.$t('page.table') }),
        icon: 'tsfont-chart-table'
      }, {
        type: 'code',
        title: this.$t('page.addtarget', { target: this.$t('page.code') }),
        icon: 'tsfont-code'
      }],
      range: null,
      showDialog: false
