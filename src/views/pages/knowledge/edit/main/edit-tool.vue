    ...
    <div v-if="search.searchShow" class="search-div dividing-color input-border">
      ...
      <div class="findDiv">
        ...
        <span class="clipSpan text-tip">
          <i class="tsfont-left" :disabled="!searchNum" @click="goPrev"></i> 
          <span>{{ searchNum? enterNum+'/'+searchNum :$t('term.knowledge.notresult') }}</span>
          <i class="tsfont-right" :disabled="!searchNum" @click="goNext"></i>
        </span>
      </div>
      ...
      >
      <span class="search-btn text-btn bg-grey" :disabled="!searchNum" @click="replaceFn">{{ $t('button.replace') }}</span>
      <span class="search-btn text-btn bg-grey" :disabled="!searchNum" @click="replaceFn('all')">{{ $t('page.globalReplacement') }}</span>
      <i class="ts-remove text-tip" :title="$t('term.knowledge.tooltip.search')" @mousedown="searchFn()"></i>
    </div>
    <aDialog
