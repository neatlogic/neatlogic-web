            ...
            <div slot="content" class="version-main">
              <div class="version-list">
                ...
                <div class="version-content m-border">
                  <p>
                    <!-- <img class="badge" src="~@/resources/assets/images/status/activation.png" alt="" /> -->
                    {{ currentVersion.versionName }}
                    <!-- <span class="status-text">激活</span> -->
                ...
                <div v-for="item in historicalVersionList" :key="item.id" class="version-content m-border">
                  ...
                  <div class="btn-list">
                    <div class="action-group">
                      <span v-if="item.isSwitchable == 1" class="action-item tsfont-arrow-right" @click="backVersion(item)">{{ $t('button.rollback') }}</span>
                      <span v-if="item.isDeletable == 1" class="action-item tsfont-trash-o" @click="delVersion(item)">{{ $t('button.delete') }}</span>
                      <span class="action-item  tsfont-compare" @click="comparisonVer(item)">{{ $t('button.comparison') }}</span>
                    </div>
                  </div>
                </div>
              </div>
