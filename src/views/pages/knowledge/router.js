...
export default [
  ...
  },
  {
    ...
    meta: {
      title: 'router.knowledge.knowledgedetail',
      ismenu: false,
      icon: 'tsfont-list',
      authority: '',
      type: 'overview'
  ...
  },
  {
    ...
    meta: {
      title: 'router.knowledge.knowledgeedit',
      ismenu: false,
      icon: 'tsfont-edit',
      authority: '',
      type: 'overview'
  ...
  },
  {
    ...
    meta: {
      title: 'router.knowledge.circlemanage',
      ismenu: true,
      icon: 'tsfont-book',
  ...
  },
  {
    ...
    meta: {
      title: 'router.knowledge.circleedit',
      ismenu: false,
      authority: 'KNOWLEDGE_CIRCLE_MODIFY'
    }
  },
  {
    ...
    meta: {
      title: 'router.knowledge.templatemanage',
      ismenu: true,
      icon: 'tsfont-modules',
  ...
  },
  {
    ...
    meta: {
      title: 'router.knowledge.templateedit',
      ismenu: false,
      authority: 'KNOWLEDGE_TEMPLATE_MODIFY'
    }
  },
  {
    ...
    meta: {
      title: 'router.knowledge.reviewdetail',
      ismenu: false,
      icon: 'tsfont-label',
      authority: '',
      type: 'overview'
  ...
  },
  {
    ...
    meta: {
      // title: '\u200E',
      title: 'router.knowledge.knowledgetypemanage',
      ismenu: false,
      icon: 'tsfont-label',
  ...
  },
  {
    ...
    meta: {
      title: 'router.knowledge.knowledgesearch',
      ismenu: false,
      authority: ''
    }
  }
