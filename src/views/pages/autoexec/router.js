...
export default [
  ...
  },
  {
    ...
    component: jobManage,
    meta: {
      title: 'router.autoexec.jobmanage',
      ismenu: true,
      icon: 'tsfont-history',
  ...
  },
  {
    ...
    component: jobDetail,
    meta: {
      title: 'router.autoexec.jobdetail',
      ismenu: false,
      icon: 'tsfont-history',
      authority: '',
      type: 'detail'
  ...
  },
  {
    ...
    meta: {
      title: 'router.autoexec.editthebatchpublishjob',
      ismenu: false
    }
  },
  {
    ...
    meta: {
      title: 'router.autoexec.executebatchpublishjob',
      ismenu: false
    }
  },
  {
    ...
    meta: {
      title: 'router.autoexec.executepublishjob',
      ismenu: false
    }
  },
  {
    ...
    meta: {
      title: 'router.autoexec.combinationtool',
      ismenu: true,
      icon: 'tsfont-flow',
      authority: 'AUTOEXEC_BASE',
      type: 'tool'
  ...
  },
  {
    ...
    meta: {
      title: 'router.autoexec.combinationtooldetail',
      ismenu: false,
  ...
  },
  {
    ...
    meta: {
      title: 'router.autoexec.toollibrary',
      ismenu: true,
      icon: 'tsfont-tool',
  ...
  },
  {
    ...
    meta: {
      title: 'router.autoexec.customtoollibrary',
      ismenu: true,
      icon: 'tsfont-script',
      authority: 'AUTOEXEC_SCRIPT_SEARCH',
      type: 'tool'
  ...
  },
  {
    ...
    meta: {
      title: 'router.autoexec.scriptdetails',
      ismenu: false,
      icon: 'tsfont-script',
      authority: '',
      type: 'detail'
  ...
  },
  {
    ...
    component: scriptAdd,
    meta: {
      title: 'router.autoexec.addscript',
      ismenu: false,
      icon: 'tsfont-script',
      authority: '',
      type: 'detail'
  ...
  },
  {
    ...
    meta: {
      title: 'router.autoexec.toollibrarydetail',
      ismenu: false,
      icon: 'tsfont-tool',
      authority: 'AUTOEXEC_SCRIPT_SEARCH',
      type: 'detail'
  ...
  },
  {
    ...
    meta: {
      title: 'router.autoexec.customizetoolapproval',
      ismenu: false,
      icon: 'tsfont-script',
      authority: 'AUTOEXEC_SCRIPT_SEARCH',
      type: 'detail'
  ...
  },
  {
    ...
    meta: {
      title: 'router.autoexec.tooltestpage',
      ismenu: false,
      icon: '',
      authority: 'AUTOEXEC_BASE',
      type: 'detail'
  ...
  },
  {
    ...
    meta: {
      title: 'router.autoexec.operationlevel',
      ismenu: true,
  ...
  },
  {
    ...
    meta: {
      title: 'router.autoexec.toolclassification',
      ismenu: true,
      icon: 'tsfont-type',
      authority: 'AUTOEXEC_MODIFY',
      type: 'config'
  ...
  },
  {
    ...
    meta: {
      title: 'router.autoexec.tooldirectory',
      ismenu: true,
      icon: 'tsfont-list',
      authority: 'AUTOEXEC_MODIFY',
      type: 'config'
  ...
  },
  {
    ...
    meta: {
      title: 'router.autoexec.presetparameterset',
      ismenu: true,
  ...
  },
  {
    ...
    meta: {
      title: 'router.autoexec.globalparameter',
      ismenu: true,
      icon: 'tsfont-barlist',
      authority: 'AUTOEXEC_MODIFY',
      type: 'config'
  ...
  },
  {
    ...
    meta: {
      title: 'router.autoexec.scenedefinition',
      ismenu: true,
      icon: 'tsfont-scene',
      authority: 'AUTOEXEC_MODIFY',
      type: 'config'
  ...
  },
  {
    ...
    meta: {
      title: 'router.autoexec.customtemplate',
      ismenu: true,
      icon: 'tsfont-plugin',
  ...
  },
  {
    ...
    meta: {
      title: 'router.process.servicecatalog',
      ismenu: true,
      icon: 'tsfont-star',
      authority: 'AUTOEXEC_BASE',
      type: 'quickService'
  ...
  },
  {
    ...
    meta: {
      title: 'router.autoexec.catalogmanage',
      ismenu: true,
      icon: 'tsfont-list',
