        ...
        <div style="position:relative;">
          ...
          <div class="action-group">
            <div class="action-item">
              <Button @click="closeCombineSearch">{{ $t('button.cancel') }}</Button>
            </div>
            <div class="action-item">
              <Button type="primary" @click="searchCombineSearcher">{{ $t('button.search') }}</Button>
            </div>
          </div>
        </div>
      </template>
...
export default {
        ...
        searchList: [
          {
            type: 'tree',
            name: 'typeIdList',
            label: this.$t('term.autoexec.modeltype'),
            multiple: true,
  ...
  methods: {
    ...
    simpleModeSearch(searchVal, searchMode) {
      // 简单模式搜索
      if (searchMode) {
