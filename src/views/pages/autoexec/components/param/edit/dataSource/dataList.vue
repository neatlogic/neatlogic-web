  ...
  <div class="dataList bg-op padding">
    ...
    <div class="static-main">
      <div class="static-title text-tip">
        ...
        <div class="formsetting-label require-label">{{ $t('term.autoexec.displaytext') }}</div>
      </div>
      <draggable
        ...
        <li v-for="(item, index) in dataList" :key="index">
          <div class="li-input">
            ...
            <TsFormInput
              ref="textValid"
              v-model="item.text"
              :placeholder="$t('form.placeholder.pleaseinput', {target: $t('term.autoexec.displaytext')})"
              maxlength="50"
              :index="index"
              :text="'value'"
              :validateList="validJson"
