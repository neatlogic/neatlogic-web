  ...
  <div>
    ...
    >
      <template v-slot:header>
        <div v-if="toolProfileId">{{ type == 'copy' ? $t('dialog.content.copytarget', {target: $t('term.autoexec.presetparameterset')}) : $t('page.edittarget', {target: $t('term.autoexec.presetparameterset')}) }}</div>
