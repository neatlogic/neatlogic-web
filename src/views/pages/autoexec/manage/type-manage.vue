...
export default {
  ...
  data() {
    ...
    return {
      ...
      typeForm: {
        name: {
          ...
          validateList: [
            ...
            { name: 'searchUrl',
              ...
              message: _this.$t({target: this.$t('page.name')}, 'message.content.targetisexists')
            }
          ]
        },
        description: {
        ...
        authList: {
          label: _this.$t('form.label.auth'),
          type: 'userselect',
          validateList: [{ name: 'required', message: this.$t('term.autoexec.authtousergrouprole')}], 
          multiple: true,
          transfer: true,
  ...
  methods: {
    ...
    addType() {
      this.title = this.$t('button.addtarget', {target: this.$t('page.classify')});
      this.typeId = null;
    ...
    edit(row) {
      ...
      this.title = this.$t('button.edittarget', {target: this.$t('page.classify')});
      this.typeId = row.id;
