      ...
      <template v-slot:content>
        ...
        >
          <template v-slot:showChildren="{ row }">
            <span v-if="row.source === 'batchdeploy'" class="text-href">
          ...
          <template v-slot:name="{ row }">
            <span
              v-if="row.source !== 'batchdeploy'"
              class="text-href"
              :class="{ 'ml-nm': !!row.parentId }"
              @click="toJobDetail(row)"
            >{{ row.name }}</span>
            <span v-else-if="row.source === 'batchdeploy'" class="text-href" @click="toBatchJobDetail(row)">
              {{ row.name }}
            </span>
            <Tooltip
            ...
            <div class="tstable-action">
              <ul class="tstable-action-ul">
                ...
                <template v-if="row.source != 'batchdeploy'">
                  <li v-auth="'AUTOEXEC_JOB_MODIFY'" class="icon tsfont-trash-o" @click.stop="deleteRow(row)">{{ $t('button.delete') }}</li>
                </template>
              </ul>
            </div>
          </template>
