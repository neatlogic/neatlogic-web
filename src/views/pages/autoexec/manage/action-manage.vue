...
export default {
  ...
  data() {
    ...
    return {
      ...
      //   { key: 'selection' },
      //   // { title: '唯一标识', key: 'uk'},
      //   { title: this.$i18n.t('page.name'), key: 'name' },
      //   { title: this.$i18n.t('page.type'), key: 'typeName' },
      //   { title: this.$i18n.t('page.status'), key: 'isActive' },
      //   { title: this.$i18n.t('page.description'), key: 'description', width: 400 },
  ...
  methods: {
    ...
    getTheadList(versionStatus) {
      ...
      this.theadList[index++] = { title: this.$i18n.t('page.name'), key: 'name' };
      this.theadList[index++] = { title: this.$i18n.t('page.type'), key: 'typeName' };
      if (versionStatus == 'passed') {
        this.theadList[index++] = { title: this.$i18n.t('page.status'), key: 'isActive' };
      }
      this.theadList[index++] = { title: this.$i18n.t('page.description'), key: 'description', width: 400 };
      if (versionStatus == 'passed') {
