...
<template>
  <div v-if="config">
    <div class="item-list">
      <div class="text-title">{{ $t('term.autoexec.inputparam') }}</div>
      ...
      <div v-else class="line-2 text-tip">{{ $t('page.notarget', {target: $t('term.autoexec.inputparam')}) }}</div>
    </div>
    <div class="item-list">
      <div class="text-title">{{ $t('term.autoexec.outputparameter') }}</div>
      ...
      <div v-else class="line-2 text-tip">{{ $t('page.notarget', {target: $t('term.autoexec.outputparameter')}) }}</div>
    </div>
    <div class="item-list">
