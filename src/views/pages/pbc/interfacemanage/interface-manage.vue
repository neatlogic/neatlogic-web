    ...
    <TsContain :enableCollapse="true">
      ...
      <template slot="topLeft">
        <div class="action-group">
          <div class="action-item tsfont-upload" @click="showInterfaceImportDialog()">导入接口</div>
          <div class="action-item tsfont-plus" @click="addInterface()">接口</div>
          <div v-if="searchParam.interfaceId" class="action-item tsfont-plus" @click="addProperty()">属性</div>
          <div v-if="searchParam.interfaceId" class="action-item tsfont-auto" @click="editMapping()">映射配置</div>
            ...
            <template v-slot:action="{ row }">
              <div class="tstable-action">
                <ul class="tstable-action-ul">
                  <li class="tsfont-edit" @click="editProperty(row)">编辑</li>
                  <li class="tsfont-auto" @click="editPropertyRel(row)">关系</li>
                  <li class="tsfont-trash-o" @click="deleteProperty(row)">删除</li>
                </ul>
              </div>
            </template>
          </TsTable>
