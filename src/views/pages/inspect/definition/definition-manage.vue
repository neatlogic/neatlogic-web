    ...
    <TsContain>
      <template v-slot:topLeft>
        <div class="action-group">
          <span class="ts-setting text-action icon-right action-item" @click="openInspectToolSettingDialog">巡检工具设置</span>
          <span v-if="!downloadLoading" v-download="exportExcel" class="tsfont-export action-item">导出指标和规则</span>
