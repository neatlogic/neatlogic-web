      ...
      <template slot="topLeft">
        <div class="action-group">
          <span class="action-item">
            <span class="text-action tsfont-plus" @click="addJob()">定时作业</span>
          </span>
          <span class="action-item">
            <span class="text-action tsfont-formtime" @click="showAudit()">执行记录</span>
          </span>
          <span class="action-item">
            <span class="text-action tsfont-timer" @click="showSchedulerMemoryJob()">已加载作业</span>
          </span>
