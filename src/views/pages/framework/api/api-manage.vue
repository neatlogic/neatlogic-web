      ...
      <template slot="content">
        ...
        >
          ...
          <template v-slot:authtype="{ row }">
            <div>{{ row.authtype | authtypeText }}</div>
          </template>
  ...
  data() {
    return {
      ...
      apiTypeConfig: Object.freeze({
        ...
        border: 'border',
        dataList: [
          { value: 'system', text: '内部接口' },
          { value: 'custom', text: '外部接口' }
        ],
      ...
      theadList: Object.freeze([
        //表头数据
        { title: '地址', key: 'token', width: 300 },
        { title: '名称', key: 'name', width: 300 },
        { title: '处理器', key: 'handlerName', width: 300 },
        { title: '启用审计', key: 'needAudit', minWidth: 80 },
        { title: '认证方式', key: 'authtype', minWidth: 80 },
        { title: '状态', key: 'isActive', minWidth: 60 },
        { title: '模块', key: 'moduleGroupName', minWidth: 60 },
        { title: '访问次数', key: 'visitTimes', minWidth: 60 },
