<template>
  ...
  >
      ...
      <div class="wrapper">
        <div class="item-left border-color">
          <div class="action-group">
            <div class="action-item tsfont-plus" @click="addAttribute">属性</div>
          </div>
          <div class="list">
            <div class="list-title">
              <div class="item-move">排序</div>
              <div class="item-content">属性名称</div>
            </div>
                ...
                <transition-group>
                  ...
                  >
                    ...
                    >
                      ...
                      <div slot="content">
                        <p>该字段下有数据，不允许删除</p>
                        <p v-if="item.isDisabledDependency">{{ `${item.name}属性已被表单引用，无法删除` }}</p>
                      </div>
                    </Tooltip>
                  </div>
                </transition-group>
            ...
            <div class="static-main bg-op">
              <div class="input-border">
                <div class="static-title">
                  <label class="formsetting-label text-grey require-label" style="line-height: 1;margin-bottom: 8px;width: 148px;">值</label>
                  <label class="formsetting-label text-grey require-label" style="line-height: 1;margin-bottom: 8px;width: 148px;">显示文字</label>
                </div>
                <vuedraggable
                ...
                >
                  <li v-for="(item, index) in dataList" :key="index">
                    ...
                    <TsFormInput
                      ...
                      :validate-list="validJson"
                    ></TsFormInput>
                    <span class="tsfont-plus-o span-btn btn-add" title="新增" @click="addOption(index)"></span>
                    <span
    ...
    <template v-slot:footer>
      ...
      <Button type="primary" :disabled="!matrixAttributeList || matrixAttributeList.length == 0" @click="okAddMatrixAttribute">确定</Button>
    </template>
  </TsDialog>
</template>
<script>
