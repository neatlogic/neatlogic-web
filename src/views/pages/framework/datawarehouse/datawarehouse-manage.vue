    ...
    <TsContain>
      <template slot="topLeft">
        <div class="action-group">
          <span class="action-item tsfont-plus" @click="addReportDataSource()">数据源</span>
          <span
          ...
          <span v-auth="['ADMIN']" class="action-item"><AuditConfig title="同步记录保存期限" auditName="DATAWAREHOUSE-AUDIT"></AuditConfig></span>
        </div>
      </template>
          ...
          <template slot="action" slot-scope="{ row }">
            <div class="tstable-action">
              <ul v-if="row.status !='doing'" class="tstable-action-ul">
                <li class="tsfont-formstaticlist" @click="showReportDataSyncAudit(row)">同步记录</li>
                <li class="tsfont-play" @click="runReportDataSource(row)">同步数据</li>
                <li class="tsfont-db" @click="showReportData(row)">查看数据</li>
                <li v-if="$utils.isUserHasAuth('DATA_WAREHOUSE_MODIFY')" class="tsfont-filter-o" @click="editCondition(row)">编辑条件</li>
                <!--<li class="tsfont-cloud" @click="editReportDataSource(row)">编辑同步策略</li>-->
                <li v-if="$utils.isUserHasAuth('DATA_WAREHOUSE_MODIFY')" class="tsfont-batch-upload" @click="editReportDataSource(row)">编辑数据源</li>
