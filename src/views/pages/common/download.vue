...
.download-box {
  ...
  .download-success-bg {
    background: url('~img-module/download-success-default.png') no-repeat center center;
    background-size: 100%;
  }
  .download-fail-bg {
    background: url('~img-module/download-fail-default.png') no-repeat center center;
    background-size: 100%;
  }
  .downloading-bg {
    background: url('~img-module/downloading-default.png') no-repeat center center;
    background-size: 100%;
  }
  .theme-dark & {
      .download-success-bg {
        background: url('~img-module/download-success-dark.png') no-repeat center center;
        background-size: 100%;
    }
    .download-fail-bg {
      background: url('~img-module/download-fail-dark.png') no-repeat center center;
      background-size: 100%;
    }
    .downloading-bg {
      background: url('~img-module/downloading-dark.png') no-repeat center center;
      background-size: 100%;
    }
  }
}
