  ...
  <div class="topnav-user">
    ...
    >
      ...
      <DropdownMenu slot="list" class="dropdown-menu" style="width:180px;">
        ...
        <DropdownItem v-if="env && env=='development' " @click.native="changeLanguage()">
...
export default {
  ...
  methods: {
    initLanguage() {
      let lang = this.$utils.getCookie('neatlogic_language') || 'zh';
    ...
    changeLanguage() {
      ...
      this.$utils.setCookie('neatlogic_language', this.$i18n.locale, {expires: 7});
      // this.$router.go(0);
    },
    initTheme() {
