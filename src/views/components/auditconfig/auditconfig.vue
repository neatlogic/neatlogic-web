<template>
  ...
  >
    ...
    <div slot="content">
      ...
      ></TimeSelect>
      <div class="mt-nm text-grey">{{ $t('message.content.autoexec.savedeadlinenolimit') }}</div>
      <div class="mt-nm text-right"><Button type="primary" size="small" @click="saveAuditConfig()">{{ $t('button.save') }}</Button></div>
    </div>
  </Poptip>
</template>
<script>
