  ...
  <div v-if="!loading" class="radius-lg bg-op">
        ...
        <div slot="content">
          <div class="sort-container">
            <div class="sort-thead padding-xs">
              <div class="sort-handle text-grey" style="text-align:center">顺序</div>
              <div class="sort-show text-grey" style="text-align:center">显示</div>
              <div class="sort-name text-grey">列名</div>
            </div>
            <draggable
              v-if="thList"
              v-model="thList"
            ...
            >
              ...
              >
                <div class="ts-bars sort-handle" style="text-align:center"></div>
    ...
    <div v-else>
      ...
      <div v-else-if="pageSize > 0 && pageType == 'carousel'" ref="tablepage" class="tstable-page text-center">
        <Button :disabled="current == 1" @click.native="getCarouselPage('prev')">上一页</Button>
        <Button class="ml-md" @click.native="getCarouselPage('next')">下一页</Button>
      </div>
    </div>
  </div>
