  ...
  <div class="user-info-wrap">
    ...
    <div v-else class="usercard-body">
      ...
      <ul class="content-wrap">
        <li>
          <span class="content-label text-grey">手机</span>
          <span class="content-text">
            {{ userInfo.phone || '-' }}
          </span>
        </li>
        <li>
          <span class="content-label text-grey">邮箱</span>
          <span class="content-text">
            {{ userInfo.email || '-' }}
          </span>
        </li>
        <li>
          <span class="content-label text-grey">角色</span>
        ...
        <li>
          <span class="content-label text-grey">分组</span>
