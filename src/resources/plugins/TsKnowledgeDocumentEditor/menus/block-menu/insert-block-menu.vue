...
<script>
import MenuComponent from '@/resources/plugins/TsKnowledgeDocumentEditor/menus/block-menu/src/click/index.js';
export default {
  name: 'MenuList',
  components: {
    ...MenuComponent,
    TableGridSelector: () => import('@/resources/plugins/TsKnowledgeDocumentEditor/menus/block-menu/src/hover/table-grid-selector.vue')
  },
  props: {},
  data() {
    return {
