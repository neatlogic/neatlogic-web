import { EXPRESSIONS } from '@/resources/plugins/TsSheet/form/conditionexpression/index.js';
export default {
  data() {
    return {
          ...
          for (let i = 0; i < reaction['conditionGroupList'].length; i++) {
            ...
            if (conditionList && conditionList.length > 0) {
              ...
              for (let j = 0; j < conditionList.length; j++) {
                ...
                this.conditionMap[condition['uuid']] = condition;
                cScript += '(';
