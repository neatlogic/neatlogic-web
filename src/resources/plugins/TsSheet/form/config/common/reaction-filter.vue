<template>
  <div>
    <Row :gutter="10" class="mb-sm">
      <Col :span="10" class="text-grey">属性</Col>
      <Col :span="2" class="text-grey"></Col>
      <Col :span="10" class="text-grey">组件值</Col>
      <Col :span="2" class="text-grey"></Col>
    </Row>
    <Row
    ...
    >
      ...
      <Col :span="2" style="text-align:center;line-height:30px">等于</Col>
      <Col :span="10">
        <TsFormSelect
          ref="select"
          transfer
    ...
    <div class="text-href tsfont-plus" @click="addFilterRule">过滤条件</div>
  </div>
</template>
<script>
export default {
