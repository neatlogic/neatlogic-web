<template>
  <div>
    <TsFormItem label="排列方向" labelPosition="top">
      <TsFormRadio
    ...
    <TsFormItem label="数据源" labelPosition="top">
      <TsFormRadio
    ...
    <TsFormItem v-if="config.dataSource === 'static'" label="下拉选项" labelPosition="top">
    ...
    <TsFormItem v-if="config.dataSource === 'matrix'" label="矩阵" labelPosition="top">
    ...
    <TsFormItem v-if="config.matrixUuid && config.dataSource === 'matrix' && selectMatrixConfig" labelPosition="top" label="过滤条件">
...
export default {
  ...
  data() {
    return {
      ...
      directionList: [{value: 'vertical', text: '纵向'}, {value: 'horizontal', text: '横向' }],
      mappingDataList: [],
      matrixConfig: {
