<template>
  <div class="form-item">
    <i v-if="showComponent(formItem) && formItem.config && formItem.config.isRequired" class="require-tip text-error">*</i>
    ...
    <component
      ...
      :mode="mode"
      :filter="filter"
      :readonly="mode != 'defaultvalue'?formItem.config && formItem.config.isReadOnly:false"
